    ...
    <div class="container my-5" id="about-us-id">
        <div class="row">
            ...
            <div class="col-md-7 my-4">
                ...
                <p>
                    We are one of the biggest library in Indonesia, established by PT Musang. Ever since our establishment
                    in 1999, we have been one of the most loved and visited library in Indonesia, with our excellent
                    ambience and various collection of books. Having reached success in our physical location of the
                    library, we are now branching out to the digital library form through this website to further reach the
                    books aficionado so that they can borrow books from us more conveniently.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="awards-section pt-50 pb-100" id="awards">
        ...
        <div class="col-lg-5 mb-30">
            <div class="awards-content">
                ...
                <p>Take a look at all the awards PM Library has received. These awards are a testament to our commitment to
                    build a library with high quality customer service, book collections, ambience, and architectural design
                    so that every customer would be interested in visiting us and reading more books to improve their
                    literacy.</p>
            </div>
        </div>
    </div>
