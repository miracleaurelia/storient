                    ...
                    <div class="col-md-3">
                        <ul class="list-group">
                            <li class="list-group-item">
                                <a @if (View::getSection('title') == 'Display Book') href="/display/book"
                                    @elseif (View::getSection('title') == 'Update Book') href="/updateView/book"
                                    @elseif (View::getSection('title') == 'Delete Book') href="/delete/book"
                                    @endif>
                                    All
                                </a>
                            </li>
                            @foreach ($categories as $category)
                                <li class="list-group-item">
                                    <a @if (View::getSection('title') == 'Display Book') href="/display/category/{{ $category->id }}"
                                        @elseif (View::getSection('title') == 'Update Book') href="/updateView/book/{{ $category->id }}"
                                        @elseif (View::getSection('title') == 'Delete Book') href="/delete/book/{{ $category->id }}"
                                        @endif>
                                        {{ $category->name }}
                                    </a>
                                </li>
